                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm border border-brand-accent/15 bg-white text-xs font-medium text-brand-accent hover:bg-brand-accent/5 transition-colors cursor-pointer">
                    ...
                    <button
                      ...
                      className={clsx(
                        "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm text-xs font-medium transition-colors cursor-pointer",
                        resident.status === "Active"
                          ? "border border-status-error/20 bg-status-error/5 text-status-error hover:bg-status-error/10"
                          : "border border-brand-primary/20 bg-brand-primary/5 text-brand-primary hover:bg-brand-primary/10"
                      )}>
                      {resident.status === "Active" ? (
                        <>
